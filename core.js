...
function refreshPerSec(delta){
	...
	var perSecondMultiplier = speedFactor * (1 + (resourceEfficiencyTech.current * 0.1)) * (1 + (Game.stargaze.entries.darkMatter.count * dmBoost));
	...
	var scienceMultiplier = speedFactor * (1 + (scienceEfficiencyTech.current * 0.2)) * (1 + (Game.stargaze.entries.darkMatter.count * dmBoost));
