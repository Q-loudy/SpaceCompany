...
function refreshPerSec(delta){
	...
	var perSecondMultiplier = speedFactor * Math.pow(1.1, resourceEfficiencyTech.current) * (1 + (Game.stargaze.entries.darkMatter.count * dmBoost));
	...
	var scienceMultiplier = speedFactor * Math.pow(1.2, scienceEfficiencyTech.current) * (1 + (Game.stargaze.entries.darkMatter.count * dmBoost));
